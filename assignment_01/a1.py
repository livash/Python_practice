...
def get_minutes(seconds):
    ...
    Return the number of minutes in a specified number of seconds

    Precondition: returned result < 60
    >>> get_minutes(3800)
    3
    """
...
def get_seconds(seconds):
    ...
    Return the number of seconds in a specified number of seconds
